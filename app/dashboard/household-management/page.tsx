...
import { HouseholdDetailsPanel } from "@/components/monitoring/HouseholdDetailsPanel";
import { Dialog, DialogContent, DialogTitle, DialogDescription, DialogClose } from "@/components/ui/dialog";
import type { HouseholdProfile } from "@/types/monitoring";

const HouseholdManagementMap = dynamic(
    () => import("@/components/monitoring/HouseholdManagementMap").then((m) => m.HouseholdManagementMap),
    { ssr: false }
);
