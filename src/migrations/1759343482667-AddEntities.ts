...
export class AddEntities1759343482667 implements MigrationInterface {
    name = 'AddEntities1759343482667'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "raw_name" text NOT NULL, "brand" text, "category" text, "plant_based" boolean NOT NULL DEFAULT false, "quantity" integer NOT NULL, "unit_price" numeric NOT NULL, "line_total" numeric NOT NULL, "matched_shopping_list" boolean NOT NULL DEFAULT false, "invoiceId" uuid, CONSTRAINT "PK_53b99f9e0e2945e69de1a12b75a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "invoices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "currency" text NOT NULL, "payment_method" text NOT NULL, "notes" text, "issued_date" date, "issued_time" TIME, "subtotal" numeric NOT NULL, "discount" numeric NOT NULL, "tax" numeric NOT NULL, "grand_total" numeric NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "vendorId" uuid, "userId" uuid, "scansId" uuid, CONSTRAINT "PK_668cef7c22a427fd822cc1be3ce" PRIMARY KEY ("id"))`);
